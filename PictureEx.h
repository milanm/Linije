...
public:
	BOOL SetBackgroundDC(LPCTSTR lpBitmapName, int nXOffset, int nYOffset, int nWidth, int nHeight);
	BOOL SetBackgroundDC(HDC hSourceDC, int nXOffset, int nYOffset, int nWidth, int nHeight);
	...
	void upisi_oblik(int);
	int uzmi_oblik(void);
	void upisi_misa(bool m) { misPreko = m; }
	void upisi_klik(bool k) { kliknuto = k; }
	bool uzmi_klik() { return kliknuto; }
